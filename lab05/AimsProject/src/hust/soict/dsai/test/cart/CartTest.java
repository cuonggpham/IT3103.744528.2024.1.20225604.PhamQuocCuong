...
public class CartTest {
    public static void main(String[]  args){
		...
		// DigitalVideoDisc dvd1 = new DigitalVideoDisc(87, "Animation", "Roger Allers", "The Lion King", 19.95f);
		// cart.addMedia(dvd1);
		// DigitalVideoDisc dvd2 = new DigitalVideoDisc(87, "Science Fiction", "George Lucas", "Star Wars", 24.95f);
		// cart.addMedia(dvd2);
